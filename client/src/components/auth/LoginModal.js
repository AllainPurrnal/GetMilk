          ...
          <ModalBody>
            ...
            <Form onSubmit={this.onSubmit}>
              <FormGroup>
                ...
                <Input type='text' name='password' id='password' placeholder='password' onChange={this.onChange} className='mb-3' />
...
const mapStateToProps = (state) => ({
  isAuthenticated: state.auth.isAuthenticated, // We pull these in from the root reducer
  error: state.error
});
